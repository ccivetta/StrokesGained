...
public class Main {
    public static void startHole(int h) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Double> f7= new ArrayList<>();
        ...
        ArrayList<Double> s6= new ArrayList<>();
        ArrayList<Double> s7= new ArrayList<>();
        ...
        ArrayList<Double> x6= new ArrayList<>();
        ArrayList<Double> x7= new ArrayList<>();
        ArrayList<Double> g1= new ArrayList<>();
        ArrayList<Double> g2= new ArrayList<>();
        ArrayList<Double> g3= new ArrayList<>();
        ArrayList<Double> g4= new ArrayList<>();
        ArrayList<Double> g5= new ArrayList<>();
        ArrayList<Double> g6= new ArrayList<>();
        ArrayList<Double> g7= new ArrayList<>();
        ArrayList<Double> g8= new ArrayList<>();
        ArrayList<Double> g9= new ArrayList<>();
        ArrayList<Double> g10= new ArrayList<>();
        ArrayList<Double> g11= new ArrayList<>();
        ArrayList<Double> g12= new ArrayList<>();
        ArrayList<Double> g13= new ArrayList<>();
        ArrayList<Double> g14= new ArrayList<>();
        ArrayList<Double> g15= new ArrayList<>();
        Scanner scan = new Scanner(System.in);
        int hole = 1;
        ArrayList<String> shots = new ArrayList<>();
        ArrayList<Double> distances = new ArrayList<>();
        double[] Tvalues = {0, 0, 0, 0, 2.92, 2.99, 2.97, 2.99, 3.05, 3.12, 3.17, 3.25, 3.45, 3.65, 3.71, 3.79, 3.86, 3.92, 3.96, 3.99, 4.02, 4.08, 4.17, 4.28, 4.41, 4.54, 4.65, 4.74, 4.79, 4.82};
        double[] Rvalues = {2.59, 2.78, 2.91, 2.96, 3.02, 3.08, 3.15, 3.23, 3.31, 3.42, 3.53, 3.64, 3.74, 3.83, 3.9, 3.95, 4.02, 4.11, 4.21, 4.3, 4.34, 4.39, 4.48, 4.59, 4.72, 4.85, 4.97, 5.05, 5.1, 5.13};
        double[] Svalues = {2.53, 2.82, 3.15, 3.24, 3.23, 3.21, 3.22, 3.28, 3.4, 3.55, 3.7, 3.84, 3.93, 4, 4.04, 4.12, 4.26, 4.41, 4.55, 4.69, 4.73, 4.78, 4.87, 4.98, 5.11, 5.24, 5.36, 5.44, 5.49, 5.52};
        double[] Gvalues = {1.04, 1.13, 1.23, 1.34, 1.42, 1.5, 1.56, 1.61, 1.78, 1.87, 1.98, 2.06, 2.14, 2.21, 2.4};
        double[] Xvalues = {0, 0, 0, 0, 3.8, 3.78, 3.8, 3.81, 3.82, 3.87, 3.92, 3.97, 4.03, 4.1, 4.2, 4.31, 4.44, 4.56, 4.66, 4.75, 4.79, 4.84, 4.93, 5.04, 5.17, 5.3, 5.42, 5.5, 5.55, 5.58};
        double[] Fvalues = {2.4, 2.6, 2.7, 2.75, 2.8, 2.85, 2.91, 2.98, 3.08, 3.19, 3.32, 3.45, 3.58, 3.69, 3.78, 3.84, 3.88, 3.95, 4.03, 4.11, 4.15, 4.2, 4.29, 4.4, 4.53, 4.66, 4.78, 4.86, 4.91, 4.94};
        for (int i = 1; i <= 30; i++) {
            distances.add((double) (20 * i));
            //System.out.print(distances.get(i-1) + " ");
        }
        ArrayList<Double> gDistances = new ArrayList<>();
        for (int i = 3; i < 11; i++){
        ...
        while (true) {
            double num1 = 0;
            double num2 = 0;
            if (addShot(shots, scan.nextLine()) == 1) {
                if (iter == 1) {
                    break;
                }
                hole++;
